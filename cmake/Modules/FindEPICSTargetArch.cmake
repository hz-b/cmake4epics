...
if(UNIX)
  ...
  elseif(CMAKE_SYSTEM_NAME MATCHES Darwin)
    set(EPICS_CLASS darwin)
    set(EPICS_CLASSES darwin posix default)

    if(CMAKE_SYSTEM_PROCESSOR MATCHES "^x86_64$")
      if(CMAKE_COMPILER_IS_GNUCC)
        set(EPICS_TARGET_ARCHS "darwin-x86_64-gnu")
      elseif(${CMAKE_C_COMPILER_ID} STREQUAL "AppleClang")
        # need to look that up and correct
        set(EPICS_TARGET_ARCHS "darwin-x86_64-llvm")
      else()
            message(SEND_ERROR "Unknown compiler on darwin: ${CMAKE_C_COMPILER_ID}")
      endif()
...
# Should be updated to use CMAKE_C_COMPILER_ID all over
message(STATUS "Checking c compiler brand ${CMAKE_C_COMPILER_ID}")
if(NOT EPICS_TARGET_COMPILER)
  ...
  elseif(${CMAKE_C_COMPILER_ID} STREQUAL "Clang")
    message(STATUS, "Found llvm / clang compiler")
    set(EPICS_TARGET_COMPILER llvm)
  elseif(${CMAKE_C_COMPILER_ID} STREQUAL "AppleClang")
    message(STATUS, "Found Apple llvm / clang compiler")
    set(EPICS_TARGET_COMPILER llvm)
  else()
